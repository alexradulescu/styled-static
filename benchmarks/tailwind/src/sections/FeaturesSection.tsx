...
function FeaturesWrapper({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      className={clsx("opacity-100 transition-opacity duration-[250ms] ease-out", className)}
      style={{ "--features-section-loaded": 1 } as React.CSSProperties}
      {...props}
    />
  );
}
