 ...
 * @template T - The HTML tag or component being styled
 */
export type StyledComponent<T extends HTMLTag | ComponentType<any>> = T extends HTMLTag ? ComponentType<PropsOf<T> & AsProp> : T extends ComponentType<infer P> ? ComponentType<P> : never;
/**
