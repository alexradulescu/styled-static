 ...
 */
export type StyledVariantComponent<T extends HTMLTag | ComponentType<any>, V extends VariantsConfig> = T extends HTMLTag ? ComponentType<JSX.IntrinsicElements[T] & VariantProps<V> & TransientProps> : T extends ComponentType<infer P> ? ComponentType<P & VariantProps<V> & TransientProps> : never;
/**
...
export interface StyledElementBuilder<T extends HTMLTag> {
     ...
     */
    attrs<A extends Partial<JSX.IntrinsicElements[T]>>(attrs: A | ((props: JSX.IntrinsicElements[T] & TransientProps) => A)): (strings: TemplateStringsArray, ...interpolations: never[]) => StyledComponent<T>;
    /**
